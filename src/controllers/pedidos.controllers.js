...
export const pago= async (req, res) => {
    ...
    try {
      ...
      const session = await stripeInstance.checkout.sessions.create({
        ...
        mode: 'payment',
        success_url: 'https://cajonescaballeroback.onrender.com/exito?resultado=exito',
        cancel_url: 'https://cajonescaballeroback.onrender.com/cancelacion?resultado=cancelado',
      });
